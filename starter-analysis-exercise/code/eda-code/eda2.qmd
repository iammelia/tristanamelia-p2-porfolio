...
Figures were not done by Leo. I had to create myself.
```{r}
p5 <- mydata %>% ggplot(aes(x = `Hair Color`, y = Height)) + geom_boxplot()
plot(p5)
figure_file = here("starter-analysis-exercise","results","figures","height-hair.png")
ggsave(filename = figure_file, plot=p5)

p6 <- mydata %>% ggplot(aes(x = Inseam, y = Height)) + geom_point()
plot(p6)
figure_file = here("starter-analysis-exercise","results","figures","height-inseam.png")
